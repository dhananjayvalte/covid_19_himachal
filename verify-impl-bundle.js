...
- Check random himachal in concepts for each type to see if all attributes are same in current file 
and new file
- Compare Number of form element groups and number of form elements per each form
- Check random himachal of form elments to see if attributes are the same
